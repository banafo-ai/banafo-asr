...
public class ClientSequential {
    ...
    private static final Logger logger = Logger.getLogger(ClientSequential.class.getName());
    ...
    public ClientSequential(String serverAddr, int serverPort, String waveFilename) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new Thread(() -> {
            for (String waveFilename : waveFilenames) {
                ...
                ClientSequential client = new ClientSequential(serverAddr, serverPort, waveFilename);
                client.sendWaveFile();
            }
        }).start();
